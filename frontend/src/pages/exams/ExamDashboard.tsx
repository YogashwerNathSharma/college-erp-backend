  ...
  return (
    <div className="p-6 space-y-6 max-w-[1600px] mx-auto">
      ...
      <div className="grid grid-cols-4 sm:grid-cols-6 lg:grid-cols-6 gap-1.5 sm:gap-2">
        {[
          { label: "Dashboard", icon: LayoutDashboard, route: "/exam-dashboard", color: "bg-teal-500", lightBg: "bg-teal-50 dark:bg-teal-950/50" },
          { label: "All Exams", icon: FileText, route: "/exams", color: "bg-blue-500", lightBg: "bg-blue-50 dark:bg-blue-950/50" },
          { label: "Grade Settings", icon: ClipboardCheck, route: "/grade-settings", color: "bg-green-500", lightBg: "bg-green-50 dark:bg-green-950/50" },
          { label: "Exam Reports", icon: BarChart3, route: "/exam-reports", color: "bg-indigo-500", lightBg: "bg-indigo-50 dark:bg-indigo-950/50" },
          { label: "Seating Plan", icon: Grid3X3, route: "/exam-seating-plan", color: "bg-purple-500", lightBg: "bg-purple-50 dark:bg-purple-950/50" },
          { label: "Admit Card", icon: CreditCard, route: "/exam-admit-card", color: "bg-orange-500", lightBg: "bg-orange-50 dark:bg-orange-950/50" },
        ].map((action) => (
          <button
            key={action.label}
