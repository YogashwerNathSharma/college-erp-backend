  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="border-b px-4 py-3 flex items-center gap-4 print:hidden">
        <Link to="/" className="text-muted-foreground hover:text-foreground cursor-pointer">
        ...
        <aside className="w-64 border-r overflow-y-auto p-4 space-y-2 print:hidden">
          ...
          {exams === undefined ? (
            ...
            <p className="text-sm text-muted-foreground px-1">
              No published exams. Generate seating first.
            </p>
          ) : (
        ...
        <main className="flex-1 overflow-auto p-4">
          {!selectedExamId ? (
            <div className="h-full flex items-center justify-center text-muted-foreground">
              <p>Select an exam to view admit cards</p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <AdmitCardGrid
                ...
                exam={selectedExam}
                filterClass={selectedClass === "all" ? undefined : selectedClass}
              />
            </div>
          )}
        </main>
