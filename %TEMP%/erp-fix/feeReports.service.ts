...
export const getDailyCollection = async (
  tenantId: string,
  options: { date?: string; fromDate?: string; toDate?: string; academicYearId?: string }
) => {
...
export const getFineReport = async (
  tenantId: string,
  options: { fromDate?: string; toDate?: string; classId?: string; academicYearId?: string }
) => {
  const where: any = {
    tenantId,
    isDeleted: false,
...
export const getCollectionRegister = async (
  tenantId: string,
  options: { fromDate?: string; toDate?: string; method?: string; academicYearId?: string }
) => {
  const dateFilter = buildDateFilter(options.fromDate, options.toDate);
