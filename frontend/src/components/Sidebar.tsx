    ...
    <>
      ...
      {sidebarOpen && (
        <div className="md:hidden fixed inset-0 z-50 flex print:hidden">
          ...
          {/* Sidebar Drawer */}
          <div className="relative flex flex-col w-[280px] max-w-xs h-full bg-slate-900/95 backdrop-blur-md text-white border-r border-white/10 shadow-2xl transition-transform duration-300">
            {/* Header */}
