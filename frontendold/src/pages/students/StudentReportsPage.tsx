        ...
        <div className="bg-white rounded-xl shadow-sm border p-5 mb-6">
          ...
          <div className="mt-4">
            <button
              ...
              disabled={loading}
              className="px-6 py-2.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 text-sm font-medium disabled:opacity-50 transition-colors"
            >
        ...
        <div className="bg-white rounded-xl shadow-sm border overflow-hidden">
          ...
          <div className="flex items-center justify-between px-5 py-4 border-b bg-gray-50">
            ...
            <div className="flex gap-2">
              ...
              <button
                onClick={handlePrint}
                className="px-3 py-1.5 bg-blue-50 text-blue-700 rounded-lg hover:bg-blue-100 text-xs font-medium border border-blue-200"
              >
                🖨️ Print
              </button>
            </div>
