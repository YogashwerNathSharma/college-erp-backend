...
const FeeCollectionPage: React.FC = () => {
  ...
  const handlePrintReceipt = async () => {
    ...
    printDocument("fee_receipt", {
      ...
      totalPaidTillDate: lastReceipt.totalPaidTillDate || lastReceipt.feeInfo.paidAmount || lastReceipt.payment.amount,
      ...
      installmentAmount: lastReceipt.feeInfo.totalAmount || 0,
      installmentNet: lastReceipt.feeInfo.netAmount || 0,
      annualFee: lastReceipt.totalAnnualFee || summary?.totalAmount || 0,
      annualDiscount: summary?.totalDiscount || 0,
      feePeriod: lastReceipt.monthsCovered?.from && lastReceipt.monthsCovered?.to
        ? `${lastReceipt.monthsCovered.from} to ${lastReceipt.monthsCovered.to}`
        : "",
      session: lastReceipt.studentInfo?.session || "",
  ...
  return (
    ...
    <div className="p-3 md:p-6 max-w-7xl mx-auto box-border overflow-x-hidden">
                    ...
                    <td className="px-3 py-2 text-center">
                      ...
                      <button onClick={() => {
                        ...
                        setLastReceipt({
                          ...
                          monthsCovered: null,
                          totalAnnualFee: summary?.totalAmount || 0,
                          totalPaidTillDate: summary?.totalPaid || 0,
                          remainingBalance: summary?.totalBalance || 0,
                          studentInfo: { session: "" },
                          nextDueMonth: null,
                        });
      ...
      {paymentModal && (
        ...
        createPortal(<div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-2 sm:p-3 overflow-y-auto backdrop-blur-sm animate-fade-in">





          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl p-4 sm:p-5 my-auto max-h-[96vh] overflow-y-auto box-border">





            <h3 className="text-base font-bold text-gray-900 mb-0.5">Collect Payment</h3>





            <p className="text-xs text-gray-500 mb-3">Installment #{paymentModal.installmentNo}</p>
            ...
            {paymentModal.feeItems.length > 0 && (
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-2.5 sm:p-3 mb-3">





                <p className="text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-1.5">Fee Particulars:</p>
                ...
                <div className="space-y-1 max-h-[120px] overflow-y-auto pr-1">
                  ...
                  {paymentModal.feeItems.map((item, idx) => (
                    ...
                    <label key={idx} className="flex items-center justify-between text-xs cursor-pointer hover:bg-white px-2 py-1 rounded-lg transition-all border border-transparent hover:border-gray-100">
                ...
                <div className="border-t border-gray-200 mt-2 pt-2 flex items-center justify-between gap-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-semibold text-gray-600">Add Fine:</span>
                    ...
                    <input
                      ...
                      className="w-20 px-2 py-1 border border-gray-300 rounded-lg text-xs font-bold outline-none"
            ...
            <div className="grid grid-cols-2 gap-2 mb-3">
              ...
              <div className="bg-green-50 border border-green-100 rounded-lg p-2 text-center">
                ...
                <p className="text-sm font-black text-green-800">{formatCurrency(paymentModal.paidAmount)}</p>
              ...
              <div className="bg-red-50 border border-red-100 rounded-lg p-2 text-center">
                ...
                <p className="text-sm font-black text-red-800">{formatCurrency(paymentModal.balance)}</p>
            ...
            <div className="space-y-2.5">
              ...
              <div>
                ...
                <label className="block text-[11px] font-bold text-gray-700 uppercase mb-0.5">Apply Discount</label>
              ...
              <div>
                ...
                <label className="block text-[11px] font-bold text-gray-700 uppercase mb-0.5">Paying Amount <span className="text-red-500">*</span></label>
                ...
                <input
                  ...
                  className="w-full px-3 py-1.5 border border-gray-300 rounded-lg text-sm font-bold outline-none focus:ring-2 focus:ring-primary-500"
              ...
              <div className="grid grid-cols-2 gap-2.5">
                ...
                <div>
                  ...
                  <label className="block text-[11px] font-bold text-gray-700 uppercase mb-0.5">Payment Method <span className="text-red-500">*</span></label>
                ...
                <div>
                  ...
                  <label className="block text-[11px] font-bold text-gray-700 uppercase mb-0.5">Reference / Transaction ID</label>
              ...
              <div>
                ...
                <label className="block text-[11px] font-bold text-gray-700 uppercase mb-0.5">Remarks</label>
                ...
                <textarea
                  ...
                  className="w-full px-2.5 py-1 border border-gray-300 rounded-lg text-sm outline-none resize-none"
            ...
            <div className="flex gap-3 mt-3">
              ...
              <button onClick={() => setPaymentModal(null)} className="flex-1 px-4 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 text-sm font-semibold">
              ...
              <button
                ...
                className="flex-1 px-4 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700 disabled:opacity-50 text-sm font-semibold shadow-sm"
