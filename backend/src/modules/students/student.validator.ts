...
export const createStudentSchema = z.object({
  ...
  fatherName: z.string().min(1, "Father name is required").trim().or(z.literal("N/A")),
  motherName: z.string().trim().default("N/A"),
  fatherPhone: z.string().min(10, "Father phone must be at least 10 digits").or(z.literal("")),
